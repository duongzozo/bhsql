create or replace procedure PBH_NONGTSH_KHD(
    dt_ctH clob,dt_ct clob,dt_dk clob,dt_dkbs clob,dt_pvi clob,dt_khd clob,b_loi out varchar2)
as
...
for b_lp in 1..kma_ma.count loop
    b_s:='PBH_NONGTSH_KHD_'||kma_ma(b_lp);

create or replace procedure PBH_PTNNNBG_NH_NH(
    b_ma_dvi varchar2,b_nsd varchar2,b_so_id number,dt_ct in out clob,dt_dk clob,dt_dkbs clob,dt_lt clob,dt_kbt clob,dt_kytt clob, dt_ttt clob,
...
insert into bh_ptnB values(
    b_ma_dvi,b_so_id,b_lan,b_so_hd,b_ngay_ht,'TNNN','G',b_ttrang,b_kieu_hd,b_so_hd_g,
    b_phong,b_ma_kh,b_ten,b_ngay_hl,b_ngay_kt,b_ma_sp,b_nt_tien,b_tien,b_nt_phi,b_phi,' ',' ',b_nsd,sysdate);
insert into bh_ptnB_ds values(b_ma_dvi,b_so_id,b_so_id,b_ten,' ');
...
/
create or replace procedure PBH_PTNNNBG_NH(
...
-- Chung
    ...
    b_kieu_kt varchar2(1); b_ma_kt varchar2(20); b_ma_cb varchar2(20);
    ...
    b_phong varchar2(10);b_so_dt number;

-- Rieng
   --dt_ct
    b_ma_sp varchar2(10); b_cdich varchar2(10);b_nghe varchar2(10);b_pvi varchar2(10); b_ghan varchar2(10);
    b_gia_ctrinh varchar2(20);b_gia_hdtv varchar2(20);b_mo_ta nvarchar2(500); b_ddiem_bh nvarchar2(500); b_cso_knai varchar2(20); b_ngay_hoi number;
    b_gh_dly varchar2(20);b_luat_ad varchar2(20);b_tygia number;b_dtuong nvarchar2(500); b_so_idP number;
...
FKH_JSa_NULL(dt_kbt); FKH_JSa_NULL(dt_kytt); FKH_JSa_NULL(dt_ttt);
if b_so_id=0 then
...
/
create or replace procedure PBH_PTNNNBG_CT(
...
/
create or replace procedure  PBH_PTNNNBG_CTbg(
    b_ma_dviN varchar2,b_nsd varchar2,b_pas varchar2,b_oraIn clob,b_oraOut out clob)
AS
    b_loi varchar2(100); b_lenh varchar2(1000); b_i1 number;
    b_ma_dvi varchar2(10); b_so_id number; b_lan number;

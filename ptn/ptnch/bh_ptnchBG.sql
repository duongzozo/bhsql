create or replace procedure PBH_PTNCHBG_CT(
...
/
create or replace procedure PBH_PTNCHBG_CTbg(
    b_ma_dviN varchar2,b_nsd varchar2,b_pas varchar2,b_oraIn clob,b_oraOut out clob)
AS
    b_loi varchar2(100); b_lenh varchar2(1000); b_i1 number;
    b_ma_dvi varchar2(10); b_so_id number; b_lan number;
...
/
create or replace procedure PBH_PTNCHBG_NH_NH(
...
insert into bh_ptnB values(
    b_ma_dvi,b_so_id,b_lan,b_so_hd,b_ngay_ht,b_nv,'G',b_ttrang,b_kieu_hd,b_so_hd_g,
...
/
create or replace procedure PBH_PTNCHBG_NH(

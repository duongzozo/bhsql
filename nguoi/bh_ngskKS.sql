create or replace procedure PBH_SK_KHD(dt_ct clob,dt_khd clob,b_loi out varchar2)
as
...
/
create or replace procedure PBH_SK_KHD_GIOI(b_nd varchar2,dt_ct clob,b_loi out varchar2)
as
	b_gioi varchar2(1);
begin
-- Dan - Kiem soat GIOI
...
create or replace procedure PBH_SK_KHD_KTUOI(
...
/
create or replace procedure PBH_SK_KHD_TGT(b_nd varchar2,dt_ct clob,b_loi out varchar2)
as
...
/
create or replace procedure PBH_SK_KHD_TGD(b_nd varchar2,dt_ct clob,b_loi out varchar2)
as
  b_ngay_hl number; b_ngay_kt number; b_kho number;
begin
...
/
create or replace procedure PBH_SK_KHD_SNT(b_nd varchar2,dt_ct clob,b_loi out varchar2)
as
  b_so_dt  number;
begin
...
/
create or replace procedure PBH_SK_KHD_SND(b_nd varchar2,dt_ct clob,b_loi out varchar2)
as
  b_so_dt  number;
begin
